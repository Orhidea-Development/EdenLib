package dev.orhidea.edenlib.nms;

import com.massivecraft.massivecore.mixin.Mixin;
import com.massivecraft.massivecore.particleeffect.ReflectionUtils;
import com.massivecraft.massivecore.util.ReflectionUtil;
import dev.orhidea.edenlib.object.ArmorStandPacket;
...
public class NmsArmorStandPacket extends Mixin {
    ...
    protected void setupCommon() throws Throwable {
        ...
        this.classCraftWorld = ReflectionUtils.PackageType.CRAFTBUKKIT_VERSION.getClass("CraftWorld");
        ...
        this.classCraftItemStack = ReflectionUtils.PackageType.CRAFTBUKKIT_VERSION_INVENTORY.getClass("CraftItemStack");
