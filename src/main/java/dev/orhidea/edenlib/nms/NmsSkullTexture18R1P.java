...
import dev.orhidea.edenlib.item.ContainerGameProfileProperty;
...
public class NmsSkullTexture18R1P extends NmsSkullTexture {
    ...
    {
        this.classCraftMetaSkull = ReflectionUtils.PackageType.CRAFTBUKKIT_VERSION_INVENTORY.getClass("CraftMetaSkull");
