...
public class LibUtil {
    ...
    public String getStackName(ItemStack itemStack) {
        ...
        try {
            Method asCraftCopy = ReflectionUtil.getMethod(ReflectionUtils.PackageType.CRAFTBUKKIT_VERSION_INVENTORY.getClass("CraftItemStack"), "asCraftCopy", ItemStack.class);
            Method asNMSCopy = ReflectionUtil.getMethod(ReflectionUtils.PackageType.CRAFTBUKKIT_VERSION_ENTITY.getClass("CraftItemStack"), "asNMSCopy", ItemStack.class);
